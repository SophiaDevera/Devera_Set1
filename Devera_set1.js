...
function savings(grossPay, taxRate, expenses){
    let takehomePay = (grossPay - (grossPay * taxRate)) - expenses
...
function materialWaste(totalMaterial, materialUnits, numJobs, jobConsumption){
    let jobWaste = totalMaterial - numJobs*jobConsumption
    return jobWaste + materialUnits
}
...
function interest(principal, rate, periods){
    let investment = rate*periods*principal + principal
